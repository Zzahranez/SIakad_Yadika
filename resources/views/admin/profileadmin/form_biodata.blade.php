        ...
        <div class="card-body">
            ...
            <form action="#" method="POST" id="personalForm">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3"> 
                        <div class="form-floating">
                            <textarea class="form-control" name="alamat" id="alamat" rows="5" placeholder="Alamat" style="height: 100px;">{{ $admin->userable->alamat }}</textarea>
                        ...
                        <div class="form-floating">
                            <select name="jenis_kelamin" class="form-select" id="jenis_kelamin">
                                <option value="laki-laki"
                                    {{ $admin->userable->jenis_kelamin == 'laki-laki' ? 'selected' : '' }}>
                                    Laki-laki</option>
                                <option value="perempuan"
                                    {{ $admin->userable->jenis_kelamin == 'perempuan' ? 'selected' : '' }}>
                                    Perempuan</option>
                            </select>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="date" name="tanggal_lahir_admin" class="form-control"
                                value="{{ $admin->userable->tanggal_lahir }}" placeholder="Enter teacher ID">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-floating">
                            <input type="text" name="no_telp" class="form-control"
                                value="{{ $admin->userable->no_telp }}" placeholder="Enter teacher ID">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('admindash.index') }}" class="btn btn-danger w-100">
