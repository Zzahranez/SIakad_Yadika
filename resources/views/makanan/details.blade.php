        ...
        <div class="row">
            <div class=" offset-3 col-md-6">
                <div class="card shadow mt-5 p-3 align-items-center">
                    ...
                    <input type="text" class=" form-floating" value="{{$makanan->nama}}">
                    <label for="NamaMakanana" class=" form-label">Harga</label>
                    <input type="text" class=" form-input" value="Rp {{ number_format($makanan->harga, 0, ',', '.') }}">
                    <a href="{{route('makanan.index')}}">Kembali</a>
                </div>
