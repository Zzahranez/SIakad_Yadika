        ...
        <div class="card-body p-4">
            ...
            <div class="list-group list-group-flush">
                @foreach ($pertemuan as $pt)
                    <div class="list-group-item border-0 d-flex justify-content-between align-items-start hover-glow"
                       onmouseover="this.classList.add('border-birumantap'); this.querySelector('.hidden-badge').classList.remove('d-none')"
                        ...
                        <a href="{{ route('nilaisiswa.showTambahNilai', $pt->id) }}"
                            class="btn btn-sm bg-birumantap text-white ms-2 hover-smooth">
