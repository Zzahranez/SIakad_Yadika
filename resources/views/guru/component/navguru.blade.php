<!-- Sidebar -->
<nav id="sidebar" class="col-lg-2 d-none d-lg-block overflow-y-auto p-3 text-white rounded-3 mb-5 sticky-top shadow-lg"
    ...
    <ul class="nav flex-column w-100">
        ...
        <li class="nav-item"><a href="{{ route('monitoringpembelajaran.index') }}"
                class="nav-link text-white {{ request()->routeIs('monitoringpembelajaran.index') ? 'active' : '' }}">
                <i class="fas fa-clipboard-check me-2"></i><span>Absensi Siswa</span></a></li>
        <li class="nav-item"><a href="{{ route('JadwalPresensiGuru.index') }}"
                class="nav-link text-white {{ request()->routeIs('JadwalPresensiGuru.index') ? 'active' : '' }}">
